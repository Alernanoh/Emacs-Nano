...
#+Author: Nano
#+Description: Nano's emacs config 
...
- [[#important-to-load-first][Important to load first]]
  ...
  - [[#unbind-example][Unbind Example]]
  - [[#evil-on-org-mode][Evil on Org mode]]
...
** Language modes
Here's an example of how to use a language mode
*** Lua mode
...
#+RESULTS:
| #[nil ((setq-local electric-pair-inhibit-predicate `(lambda (c) (if (char-equal c 60) t (,electric-pair-inhibit-predicate c))))) nil] | org-tempo-setup | org-superstar-mode | #[0 \300\301\302\303\304$\207 [add-hook change-major-mode-hook org-fold-show-all append local] 5] | #[0 \300\301\302\303\304$\207 [add-hook change-major-mode-hook org-babel-show-result-all append local] 5] | org-babel-result-hide-spec | org-babel-hide-all-hashes | #[0 \301\211\207 [imenu-create-index-function org-imenu-get-tree] 2] | toc-org-mode | org-indent-mode |
...
** Embark
This help with functionality and actions for minibuffer candidates.
#+begin_src emacs-lisp
